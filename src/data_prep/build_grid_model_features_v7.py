"""Merge v6 model features with explicit-motorway reach sensitivity metrics."""
...
DEFAULT_INPUTS = [
    "data/03_processed/grid_250m_model_features_v6.csv",
    "data/03_processed/grid_250m_road_network_reach_road_class_sensitivity.csv",
]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-csv", default="data/03_processed/grid_250m_model_features_v7.csv")
