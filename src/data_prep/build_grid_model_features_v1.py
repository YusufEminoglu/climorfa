"""Merge current grid-level features into model matrix v1."""
...
DEFAULT_INPUTS = [
    "data/03_processed/grid_250m_prelim_features.csv",
    "data/03_processed/grid_250m_lcz_weak_labels.csv",
    "data/03_processed/grid_250m_remote_sensing_features.csv",
    "data/03_processed/grid_250m_coastal_context.csv",
    "data/03_processed/grid_250m_building_floor_features.csv",
]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-csv", default="data/03_processed/grid_250m_model_features_v1.csv")
