...
\begin{minipage}{0.96\textwidth}\vspace{2pt}\scriptsize Note: Only districts with at least 100 diagnostic rows were evaluated. Macro-F1 uses classes present in the held-out district; LightGBM mean 0.723 and range 0.475--0.819. Random Forest, evaluated identically as a comparison baseline, reached mean macro-F1 0.700.\end{minipage}
\end{table*}
