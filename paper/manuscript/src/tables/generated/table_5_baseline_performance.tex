...
\begin{minipage}{0.96\textwidth}\vspace{2pt}\scriptsize Note: Blocks are nominally 1.25 km (5 by 5 grid units). Preprocessing is fit within each training fold. Values are mean $\pm$ standard deviation across five folds. These are exploratory weak-label comparisons; within each recipe, models are ordered by descending macro-F1.\end{minipage}
\end{table*}
