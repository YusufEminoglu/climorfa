...
\begin{minipage}{0.96\textwidth}\vspace{2pt}\scriptsize Note: The four-class modeling population is restricted to weak LCZ 3/6/8/9 with confidence $\geq 0.60$. Tiers were prespecified before agreement was computed. The broader unrestricted 569-cell audit had 36.9\% exact weak-label agreement and is not directly comparable to the built-subtype task.\end{minipage}
\end{table*}
