...
This appendix contains the evidence-bearing checks used to
...
external-triangulation checks, duplicate weak-label panels, and manual-audit
figures are not part of the supplementary bundle; the completed audit is
...
audit is complete and the supplementary panels provide reproducibility checks
for the reported feature, surface-model, canopy, and spatial-fold analyses.
