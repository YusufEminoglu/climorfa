...
global LCZ product now supports comparative urban and Earth-system analysis
...
The article follows a prespecified evidence boundary and reports only analyses
that have actually run. The 569-location stratified manual audit is complete
and is used for bounded validation of weak labels and tabular predictions,
while the multi-branch deep architecture remains untrained. The audit result
is therefore presented as a low-agreement validation finding, not as proof of
a finished local subtype map. This distinction prevents weak labels from being
redescribed as local ground truth and prevents a planned deep model from
becoming a black-box novelty claim.
