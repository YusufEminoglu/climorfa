...
The article is deliberately evidence-locked. It reports only analyses that have
actually run. The 569-cell stratified manual audit is complete and is used for a
bounded validation of weak labels and tabular predictions, while the multi-branch
deep architecture remains untrained. The audited results are therefore reported
as low-agreement diagnostic evidence rather than as proof of a finished local
subtype map. This distinction prevents weak labels from being redescribed as
local ground truth and prevents a planned deep model from becoming a black-box
novelty claim.
