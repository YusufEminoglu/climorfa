...
The stopping rule used here is therefore a strength. It prevents a planned
...
therefore supplies the evidence for that synthesis; it is not an unresolved data gate.
