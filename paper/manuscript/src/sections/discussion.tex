...
The municipal park comparison provides a useful targeted validation. Strong
...
CLIMORFA is designed to test whether raster and figure-ground representations
improve audited transfer, reduce systematic uncertainty, and reveal interpretable
subtype structure beyond the tabular branch. The completed audit provides a
direct reference for these comparisons, while SHAP and neural attributions can
be compared at the level of mechanism families rather than selected as
decorative examples
...
Sixth, OSM functional context is a proxy, and OSM park/garden supply is neither
a complete green inventory nor proof of access. The 2SFCA graph is
...
proxies. Eighth, multi-scale comparisons should be extended across the
125/250/500 m analysis grids. Finally, feature importance is model-specific,
correlations are bivariate, and no causal effect is estimated.

These considerations motivate continued work on multimodal representation,
multi-scale transfer, uncertainty calibration, and branch-level XAI. The
completed audit supplies a strong reference for that development and for any
subsequent climate or planning synthesis.
