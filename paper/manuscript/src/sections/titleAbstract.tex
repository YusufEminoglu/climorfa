...
16,506 cells and 374 fields from a local 5 m surface model,
...
The present evidence-locked analysis retained 5,339 cells from LCZ 3, 6, 8, and
...
and road density were positively associated. The 569-cell manual audit was
completed; among 96 high-quality cells in the four-class modeling population,
...
\begin{figure*}[p]
    ...
    climate-response diagnostics, and audited-label comparison.}
\end{figure*}
