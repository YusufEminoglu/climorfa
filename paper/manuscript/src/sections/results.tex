...
Weak-versus-audit agreement and audited model comparisons are therefore
available, with the primary four-class comparison focused on 96
high-quality units and showing substantial class-space compression.
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{fig_4_class_profiles.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{fig_6_feature_importance.png}
...
\subsection{Analytical evidence synthesis}

Table~\ref{tab:evidence_status} summarises the analytical evidence assembled by
the study: reproducible data integration, weak-label discrimination, network-
access sensitivity, transfer heterogeneity, descriptive climate relevance, and
audited comparison. Together these components define the empirical foundation
for CLIMORFA and its future multimodal extensions.
