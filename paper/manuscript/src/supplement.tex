...
does not contain retired external-triangulation diagnostics or duplicate
weak-label panels.
...
\section*{Reproducibility and evidence synthesis}
...
regenerated from the locked scripts and parameters. The manual audit and
spatial-fold outputs are reported as the empirical reference for the
multimodal framework and its extensions.
